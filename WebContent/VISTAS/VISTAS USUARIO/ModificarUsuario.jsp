...
<main class="main-container">
  ...
  <div class="container-fluid max-width-container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="flex-evenly-container align-items-center"  method="Post" action="servletModificarUsuario">
...
<%
     ...
     usuario = (Usuario)request.getAttribute("usuarioModificar"); 
 ...
 <div class="container">
            ...
            <form class="flex-column"method="Post" action="servletModificarUsuario">
				
				<label>Usuario</label>
				<input type="hidden"  value = <%=usuario.getIdUsuario() %> name="idUsuario">
				<input type="text" name="user"  value = <%=usuario.getUser_Name() %>>
				  <br/>
