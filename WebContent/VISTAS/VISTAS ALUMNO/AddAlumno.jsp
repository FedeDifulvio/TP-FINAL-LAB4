...
<section class="form__container full-width flex-center-container">
  ...
  <form class="form max-width-container flex-center-container full-width" method="Post" action="servletAgregarAlumno">
  
  	<div class="form__input-container">
      <label for="firstname">Legajo</label>
      <input required type="text" name="legajo" maxlength="10">
    </div>
